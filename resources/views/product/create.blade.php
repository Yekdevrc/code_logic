                ...
                <form action="{{ route('product.store') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" name="manufacturing_date" class="form-control @error('manufacturing_date')
                                is-invalid
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="manufacturing_price" class="form-control @error('manufacturing_price')
                                is-invalid
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="selling_price" class="form-control @error('selling_price')
                                is-invalid
